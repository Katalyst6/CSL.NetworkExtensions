...
namespace NetworkExtensions.CompatibilityTests.SomeRoads
{
    public class SomeRoadsMod : IUserMod
    {
        public const UInt64 workshop_id = 478820060;

        public string Name
        {
            get { return "Some Roads"; }
        }

        public string Description
        {
            get { return "A collection of additional roads and tracks"; }
        }
    }
    ...
    public class SomeRoadsLoader : LoadingExtensionBase
    {
        ...
        public override void OnCreated(ILoading loading)
        {
            ...
            if (container == null)
            {
                container = new GameObject("Some Roads Prefabs");
                container.AddComponent<SomeContainer>();
            }
        }
    ...
    public class SomeContainer : MonoBehaviour
    {
        ...
        public static string getModPath()
        {
            ...
            string localPath = DataLocation.modsPath + @"\CompatibilityTests\SomeRoads";
