...
using NetworkExtensions.NewNetwork.Alley.Meshes;
using UnityEngine;

namespace NetworkExtensions.NewNetwork.Alley
{
    public class AlleyBuilder : ModPart, INetInfoBuilder
    {
        public int OptionsPriority { get { return 1; } }
        public int Priority { get { return 1; } }

        public string PrefabName { get { return "Oneway Road"; } }
        public string Name { get { return "Alley"; } }
        ...
        public string ThumbnailsPath { get { return @"NewNetwork\Alley\thumbnails.png"; } }
        public string InfoTooltipPath { get { return @"NewNetwork\Alley\infotooltip.png"; } }
        ...
        public void BuildUp(NetInfo info, NetInfoVersion version)
        {
            ...
            if (version == NetInfoVersion.Ground)
            {
                ...
                var grndMesh = AlleyMeshes.GetGroundData().CreateMesh("ALLEY_GROUND");
                var grndTransMesh = AlleyMeshes.GetGroundTransitionData().CreateMesh("ALLEY_GROUND_TRS");
            ...
            switch (version)
            {
                case NetInfoVersion.Ground:
                    info.SetSegmentsTexture(
                        new TexturesSet
                           (@"NewNetwork\Alley\Textures\Ground_Segment__MainTex.png",
                            @"NewNetwork\Alley\Textures\Ground_Segment__AlphaMap.png"));
