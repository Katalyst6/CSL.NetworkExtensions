...
namespace NetworkExtensions.SomeNetwork
{
    public class PlanningRoadLargeBuilder : INetInfoBuilder
    {
        ...
        {
            info.SetSegmentsTexture(new TexturesSet(@"SomeNetwork\planning_road_2_lanes.png"));
            info.SetNodesTexture(new TexturesSet(@"SomeNetwork\planning_road_2_lanes.png"));
